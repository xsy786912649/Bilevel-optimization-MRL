...
if __name__ == "__main__":
    ...
    for i_episode in range(300):
        ...
        #torch.save(meta_policy_net, "./check_point/meta_policy_net_HalfCheetah_vel_"+str(i_episode)+".pkl")
        #output_hal = open("./check_point/running_state_HalfCheetah_vel_"+str(i_episode)+".pkl", 'wb')
        #str1 = pickle.dumps(running_state)
        #output_hal.write(str1)
        #output_hal.close()
