...
if os.path.exists("./check_point/running_state_Ant_vel_maml.pkl"):
...
if __name__ == "__main__":
    if not os.path.exists("./check_point/meta_policy_net_Ant_vel_maml.pkl"):
    ...
    for i_episode in range(500):
        ...
        target_v_list000=[0.3,0.6,0.9,1.2,1.5,1.8,2.1,2.4,2.7]
        ...
        with open('./check_point/training_log_Ant_vel_maml.csv', 'a+') as file:
        ...
        if result_after.mean()>aaaaaa:
            ...
            torch.save(meta_policy_net, "./check_point/meta_policy_net_Ant_vel_maml.pkl")
            output_hal = open("./check_point/running_state_Ant_vel_maml.pkl", 'wb')
