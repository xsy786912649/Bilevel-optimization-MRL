...
if os.path.exists("./check_point/running_state_Ant_dir_maml.pkl"):
    with open("./check_point/running_state_Ant_dir_maml.pkl",'rb') as file:
...
if __name__ == "__main__":
    if not os.path.exists("./check_point/meta_policy_net_Ant_dir_maml.pkl"):
        meta_policy_net = Policy(num_inputs, num_actions)
    else:
        meta_policy_net = torch.load("./check_point/meta_policy_net_Ant_dir_maml.pkl")
    ...
    for i_episode in range(500):
        ...
        with open('./check_point/training_log_Ant_dir_maml.csv', 'a+') as file:
        ...
        if result_after.mean()>aaaaaa:
            ...
            torch.save(meta_policy_net, "./check_point/meta_policy_net_Ant_dir_maml.pkl")
            output_hal = open("./check_point/running_state_Ant_dir_maml.pkl", 'wb')
